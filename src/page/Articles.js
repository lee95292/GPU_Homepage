...
const Articles = () => {
  ...
  ---
  layout: post
  title: "[INTG Project] 개념이 잘 정리된 링크| 테크블로그| 공식 Document 모음"
  date: 2019-08-13 05:46:00 +9000
  categories: 하나로_정리하기
  ---
  ...
  `;
  return <div>{/* <MarkdownRenderer markdown={markdonw} /> */}</div>;
};
